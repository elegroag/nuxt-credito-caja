    ...
    <div class="mx-auto max-w-7xl p-4 sm:p-8">
      ...
      <UPageCard class="mb-6">
        <div class="flex items-center justify-between">
          <div>
            <h1 class="text-3xl font-bold mb-2 text-foreground">Carga de Documentos</h1>
      ...
      <!-- Main Content -->
      <div v-else-if="solicitud" class="space-y-8 max-w-6xl mx-auto">
        <!-- Info Card -->
        ...
        <UPageCard>
          ...
          <p class="text-sm text-gray-600 mt-2">{{ progresoDocumentos }}% completado</p>
        </UPageCard>
        ...
        <div class="grid gap-6">
          <UPageCard
            ...
            :class="{
              ...
              'border-warning': !getDocumentoCargado(docReq.id) && docReq.obligatorio
            }"
          >
            <!-- Document Header -->
            <div class="px-6 py-4">
