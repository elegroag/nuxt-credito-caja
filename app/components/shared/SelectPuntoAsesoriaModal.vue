    ...
    >
      ...
      <div class="border-b px-6 py-4">
        <div class="flex items-center justify-between">
          <h2 class="text-lg font-semibold text-gray-900">Seleccionar Punto de Asesoría</h2>
      ...
      <div class="px-6 py-4 overflow-y-auto max-h-[60vh]">
        ...
        <div v-else class="space-y-3">
          <div
            ...
            :class="{
              'border-blue-500 bg-blue-50': selectedPunto?.numero === punto.numero
            }"
      ...
      <div class="border-t px-6 py-4 bg-gray-50">
        <div class="flex justify-end gap-3">
          ...
          <UButton :disabled="!selectedPunto" @click="confirmSelection"> Continuar </UButton>
        </div>
      </div>
    </div>
  </div>
